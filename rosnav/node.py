...
class RosnavNode:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        populate_laser_params(self._hyperparams, agent_namespace=self.agent_name)
        ...
        self._setup_encoder(observation_spaces, observation_spaces_kwargs)
    ...
    def _setup_encoder(
        self,
        observation_spaces: List[Union[BaseObservationSpace, BaseFeatureMapSpace]],
    ...
    def _setup_action_space(self, hyperparams: dict):
        ...
        if is_action_space_discrete:
            populate_discrete_action_space(hyperparams, agent_namespace=self.agent_name)
    ...
    def _get_model(self, architecture_name: str, checkpoint_name: str, agent_path: str):
        ...
        if not net_type or net_type != PolicyType.MLP_LSTM:
            ...
            agent = PPO.load(model_path).policy
        else:
